"""Resolve marketing airline ICAO codes for logo display and flight ID.

Regional operators (e.g. SkyWest SKW) often fly under major brands
(United UAL, Delta DAL). Logos should follow the ticketed airline.
"""
...
IATA_TO_ICAO = {
    ...
    "AY": "FIN", "AC": "ACA", "QR": "QTR", "EK": "UAE", "SQ": "SIA",
    "QF": "QFA", "NH": "ANA", "JL": "JAL", "CX": "CPA", "TK": "THY",
    "LX": "SWR", "OS": "AUA", "SN": "BEL", "LO": "LOT", "TP": "TAP",
    "AZ": "ITY", "VY": "VLG", "FR": "RYR", "U2": "EZY", "W6": "WZZ",
}
...
MARKETING_BRANDS = {
    ...
    "IB": "Iberia", "SK": "SAS", "EI": "Aer Lingus", "AY": "Finnair",
    "AC": "Air Canada", "EK": "Emirates", "SQ": "Singapore Airlines",
    "QF": "Qantas", "TK": "Turkish Airlines", "LX": "SWISS",
